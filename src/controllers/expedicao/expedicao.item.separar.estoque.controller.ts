...
import ExpedicaoItemSepararEstoqueDto from '../../dto/expedicao/expedicao.item.separar.dto';
import AppDependencys from '../../aplication/app.dependencys';

export default class ExpedicaoItemSepararEstoqueController {
  public static async get(req: Request, res: Response) {
    try {
      const repository = ExpedicaoItemSepararEstoqueController.getRepository();
      const params = ExpedicaoItemSepararEstoqueController.buildParams(req);
  ...
  public static getRepository() {
    return AppDependencys.resolve<LocalBaseRepositoryContract<ExpedicaoItemSepararEstoqueDto>>({
