...
export default class ExpedicaoPrioridadeDtoController {
  public static async get(req: Request, res: Response) {
    try {
      const repository = ExpedicaoPrioridadeDtoController.getRepository();
      const params = ExpedicaoPrioridadeDtoController.buildParams(req);
  ...
  public static getRepository() {
    return AppDependencys.resolve<LocalBaseRepositoryContract<ExpedicaoPrioridadeDto>>({
