...
import ExpedicaoSepararEstoqueDto from '../../dto/expedicao/expedicao.separar.dto';
import AppDependencys from '../../aplication/app.dependencys';

export default class ExpedicaoSepararEstoqueController {
  public static async get(req: Request, res: Response) {
    try {
      const repository = ExpedicaoSepararEstoqueController.getRepository();
      const params = ExpedicaoSepararEstoqueController.buildParams(req);
  ...
  public static getRepository() {
    return AppDependencys.resolve<LocalBaseRepositoryContract<ExpedicaoSepararEstoqueDto>>({
