...
import LocalSybaseCobrancaDigitalChaveRepository from '../../../src/repository/local.sybase.cobranca.digital.chave.repository';

describe('CRUD (Integracao.CobrancaDigitalChave)', () => {
  const repository = new LocalSybaseCobrancaDigitalChaveRepository();
