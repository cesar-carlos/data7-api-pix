...
import LocalSqlServerCobrancaDigitalPixRepository from '../../../../src/repository/integracao/local.sql.server.cobranca.digital.pix.repository';

describe('CRUD (local.sql.server.cobranca.digital.pix.repository)', () => {
  const repository = new LocalSqlServerCobrancaDigitalPixRepository();
