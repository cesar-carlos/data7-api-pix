...
import LocalSqlServerLiberacaoBloqueioRepository from '../../../../src/repository/integracao/local.sql.server.liberacao.bloqueio.repository';

describe('CRUD (local.sql.server.liberacao.bloqueio.repository)', () => {
  const repository = new LocalSqlServerLiberacaoBloqueioRepository();

  const newEntity = new LiberacaoBloqueioDto({
    codEmpresa: 1,
    codFilial: 1,
    codLiberacaoBloqueio: 9999999,
    origem: 'DM',
    codOrigem: 1,
    codCliente: 2,
