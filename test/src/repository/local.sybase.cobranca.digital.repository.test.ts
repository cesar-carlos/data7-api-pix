...
import LocalSybaseCobrancaDigitalRepository from '../../../src/repository/local.sybase.cobranca.digital.repository';

describe('CRUD (Integracao.CobrancaDigital)', () => {
  const repository = new LocalSybaseCobrancaDigitalRepository();
