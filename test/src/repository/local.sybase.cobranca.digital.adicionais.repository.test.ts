...
import LocalSybaseCobrancaDigitalAdicionaisRepository from '../../../src/repository/local.sybase.cobranca.digital.adicionais.repository';

describe('CRUD (Integracao.CobrancaDigitalAdicionais)', () => {
  const repository = new LocalSybaseCobrancaDigitalAdicionaisRepository();
