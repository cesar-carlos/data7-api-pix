...
import LocalSybaseCobrancaDigitalSituacaoRepository from '../../../src/repository/local.sybase.cobranca.digital.situacao.repository';

describe('CRUD (Integracao.CobrancaDigitalSituacao)', () => {
  const repository = new LocalSybaseCobrancaDigitalSituacaoRepository();
