...
import LocalSybaseCobrancaDigitalTituloRepository from '../../../src/repository/local.sybase.cobranca.digital.titulo.repository';

describe('CRUD (Integracao.CobrancaDigitalTitulo)', () => {
  const repository = new LocalSybaseCobrancaDigitalTituloRepository();
