...
import LocalSybaseCobrancaDigitalLogRepository from '../../../src/repository/local.sybase.cobranca.digital.log.repository';

describe('CRUD (Integracao.CobrancaDigitalDataBase)', () => {
  const repository = new LocalSybaseCobrancaDigitalLogRepository();
