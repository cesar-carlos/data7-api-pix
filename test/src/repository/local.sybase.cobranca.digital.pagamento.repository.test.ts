...
import LocalSybaseCobrancaDigitalPagamentoRepository from '../../../src/repository/local.sybase.cobranca.digital.pagamento.repository';

describe('CRUD (Integracao.CobrancaDigitalPagamento)', () => {
  const repository = new LocalSybaseCobrancaDigitalPagamentoRepository();
