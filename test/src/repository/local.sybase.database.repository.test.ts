...
import LocalSybaseCobrancaDigitalDataBaseRepository from '../../../src/repository/local.sybase.cobranca.digital.data.base.repository';

describe('CRUD (Integracao.CobrancaDigitalDataBase)', () => {
  const repository = new LocalSybaseCobrancaDigitalDataBaseRepository();
